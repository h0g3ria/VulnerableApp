...
-- Bcrypt hash (cost 10) for the password 'sunshine'
INSERT INTO auth_users VALUES (10, 'admin_lowcost', '$2b$10$Nd98jt54h6.10AfeNYFbo.Ef5YkbotE.k.z8FNfpYzEklQHhBu2H.', NULL, 'BCRYPT', 10, 'admin_lowcost@example.com', 'ADMIN');
